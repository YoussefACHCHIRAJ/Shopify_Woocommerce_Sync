...
export async function fetchProductsNotIncludeOnAllMoroccanCategory() {
  const allProducts = [];
  const allMoroccanRugsCategoryId = 561;
  let count = 0;
  let page = 1;
  while (true) {
    ...
    for (const product of products) {
      const isIncluded = product.categories.find(cat => cat.id === allMoroccanRugsCategoryId);
      console.log(product.name, "is includes? ", isIncluded);
      if (!isIncluded) {
        count++;
  ...
  console.log("==========================================================");
  console.log("Included count: ", count);
  console.log("==========================================================");
